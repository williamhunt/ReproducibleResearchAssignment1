...
```
## Warning in device(...): unable to open file
## './figure/histogramTotalStepsIgnoredNAs.png' for writing
```

```
## Warning in device(...): opening device failed
```
...
```
## Warning in device(...): unable to open file
## './figure/averageStepsPerInterval.png' for writing
```
...
```
## Warning in device(...): unable to open file
## './figure/histogramTotalStepsFilledNAs.png' for writing
```
...
```
## Warning in device(...): unable to open file
## './figure/AverageStepsbyDayType.png' for writing
```
